...
| 编号 | 图 | 说明 |
|------|-----|------|
| 01 | [DDD 领域全景](docs/架构图-v5-wip/01-DDD领域全景.html) | 5 限界上下文 + Harness 横切 · 领域依赖关系 |
| 02 | [五层技术架构](docs/架构图-v5-wip/02-五层技术架构.html) | 交互→通信→编排→能力→数据 · 层间通信协议 |
| 03 | [Supervisor 决策流程](docs/架构图-v5-wip/03-Supervisor决策流程.html) | M0-M7 流水线 · 审核-打回-升级 · M7 drift 回路 |
| 04 | [Agent 生命周期 + Harness](docs/架构图-v5-wip/04-Agent生命周期与Harness.html) | 6 阶段管道 · Harness 4 钩子 · 三引擎差异 |
| 05 | [Loop Engine + 异常处理](docs/架构图-v5-wip/05-LoopEngine与异常处理.html) | 三分类策略 · 四步恢复 · drift 纠正链路 |
| 06 | [通信与数据流](docs/架构图-v5-wip/06-通信与数据流.html) | WS 消息分类 · Observer 事件 · 状态管理 · 持久化 |
